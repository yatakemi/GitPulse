const translations = {
    en: {
        ...
        desc_lead_time_p50: "Median delivery speed. Formula: Time from PR creation to merge. Lower is faster.",
    ...
    ja: {
        ...
        metric_lead_time_p50: "リードタイム中央値",
        ...
        desc_lead_time_p50: "標準的なデリバリー速度。計算式: PR作成からマージまでの期間。短いほど迅速にリリースされています。",
