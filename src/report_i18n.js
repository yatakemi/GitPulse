const translations = {
    en: {
        ...
        desc_throughput: "Measures delivery frequency. Formula: [Merged PRs] / [Weeks]. Higher indicates a better delivery cadence.",
        desc_commit_density: "Measures activity frequency. Formula: [Total Commits] / [Weeks]. More frequent, smaller commits are easier to track.",
    ...
    ja: {
        ...
        status_declined: "悪化",
        status_stable: "安定",
        desc_throughput: "デリバリーの頻度を測定。計算式: [マージされたPR数] / [週数]。高いほどチームは頻繁に価値を提供できています。",
        desc_commit_density: "活動の細かさを測定。計算式: [総コミット数] / [週数]。コミットが頻繁であるほど、作業が適切に分解されています。",
